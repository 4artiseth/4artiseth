...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2005, 1, 24))
    ...
    # Note: Archive functionality removed - add your own archived repos if needed
